...
//         {topMovies?.map((movie) => (
//             <VideoCard key={movie._id} image={movie.image} title={movie.name} date={movie.year} 
...
import { useGetTopMoviesQuery, useGetAllMoviesQuery } from '../../../../redux/api/movies'
import { useGetUsersQuery } from '../../../../redux/api/users'
import { BASE_URL } from '../../../../redux/constants' // ✅ ADD THIS
