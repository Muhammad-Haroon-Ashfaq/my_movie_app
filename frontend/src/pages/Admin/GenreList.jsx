  ...
  const handleCreateGenre = async (e) => {
   ...
   const handleUpdateGenre = async (e) => {
    ...
    try {
      ...
      console.error(error);
      toast.error("Updated genre failed, try again.");
    }
  } 
    ...
    <div className="ml-[10rem] flex flex-col md:flex-row">
      <div className="md:w-3/4 p-3">
        ...
        <div className="flex flex-wrap">
          {genres?.map((genre) => (
            <div key={genre._id}>
              <button className="text-teal-500 bg-white border border-teal-500 py-2 px-4 rounded-lg 
         m-3 hover:bg-teal-500 hover:text-white focus:outline-none focus:ring-teal-500 
